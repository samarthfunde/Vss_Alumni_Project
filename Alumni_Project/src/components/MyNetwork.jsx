...
// import checkTick from '../assets/check_tick.png'; // Replace with actual check icon
// import myChatIcon from '../assets/mychat.png'; // Replace with actual chat icon
// import myVideoCallIcon from '../assets/myvdocall.png'; // Replace with actual video icon
...
//     setChatMessages([
//       { sender: "other", text: "Hi there!", timestamp: new Date().toISOString() },
//       { sender: "me", text: "Hello! How are you?", timestamp: new Date().toISOString() },
//       { sender: "other", text: "I'm doing great. How about you?", timestamp: new Date().toISOString() }
//     ]);
//   };
...
//                     p: 1.5, 
//                     borderRadius: 2, 
//                     bgcolor: msg.sender === "me" ? "#1976d2" : "#fff",
//                     color: msg.sender === "me" ? "#fff" : "inherit",
...
//chat & vdo call functionality code
